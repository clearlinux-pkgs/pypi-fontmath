...
Source0  : https://files.pythonhosted.org/packages/b8/4a/fe75a801004b26e7be7d8949410b19193f935c1ffbdd1f701f6f3dc4f806/fontMath-0.9.1.zip
...
%prep
%setup -q -n fontMath-0.9.1
cd %{_builddir}/fontMath-0.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642004522
...
cp %{_builddir}/fontMath-0.9.1/License.txt %{buildroot}/usr/share/package-licenses/pypi-fontmath/eacd7483dbe0f90140ab577e977c1c14d218e57a
